...
<title>정치정치</title>
	...
	<script>
		...
		function idDuplication(){
			var id = document.getElementById("user_id").value;
	 		if(id.trim() == ""){
				...
				<%-- 
				var url = "<%=root%>/user/idDuplication.do?user_id=" + id;
				window.open(url, "", "width=700, height=200, left=600");	
				 --%>
				 $.ajax({
						type: "GET",
						url: "<%=root%>/user/idDuplication.do?user_id=" + id,
						dataType: "text",
						error: function() {
							alert("통신실패!!");
						},
		...
		function preferPoliticianList(){
			...
			window.open(url, "", "width=800, height=700, left=600, scrollbars=no");
		}
	...
	<form:form modelAttribute="user" commandName="user">
		<div class="modal-body">
			<div class="form-group row">
				...
				<div class="col">
					<form:input path="user_id" class="form-control" name="user_id"/>
					<form:errors path="user_id" class="text-danger"/>
				</div>
				<div class="col-3 pl-0">
					<input type="button" value="중복확인" class="btn btn-success btn-block" onclick="idDuplication()" />
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col">
					<form:input path="user_birthdate" class="form-control" type="date" min="1910-01-01" max="2019-03-29"/>
				...
				<div class="col col-form-label">
					<div class="row">
						<div class="col-3">
							...
							<label for="Y" class="mb-0">있음</label>
						</div>
						<div class="col-3">
							<form:radiobutton path="user_voting_ex" value="N" class="" id="N" />
							<label for="N" class="mb-0">없음</label>
						</div>
					</div>
		...
		<div class="modal-footer justify-content-center">
			<div class="col-md-3">
				<input type="submit" value="회원가입" class="btn btn-primary btn-block btn-lg">
			</div>
			<div class="col-md-3">
