		...
		<div class="modal-dialog">
			<div class="modal-content text-center">
				<div class="modal-header">
					<h2 class="modal-title">게시물 작성</h2>
				</div>
				<form:form modelAttribute="post">
					<div class="modal-body">
						<!-- 
						<div class="form-group row">
							<label for="post_no" class="col-sm-3 col-form-label">게시물 번호</label>
							<div class="col">
								<form:input path="post_no" class="form-control" readonly="true"/>
								<form:errors path="post_no" class="text-danger"/>
							</div>
						</div>
						<div class="form-group row">
							<label for="commitment_no" class="col-sm-3 col-form-label">공약 번호</label>
							<div class="col">
								<form:input path="commitment_no" class="form-control" readonly="true"/>
								<form:errors path="commitment_no" class="text-danger"/>
							</div>
						</div>
						<div class="form-group row">
							<label for="user_id" class="col-sm-3 col-form-label">작성자 id</label>
							<div class="col">
						...
						<div class="form-group row">
							<label for="post_score" class="col-sm-2 col-form-label">점수</label>
							<div class="col">
								<div class="row">
									<div class="col-4">
						...
						<div class="modal-footer pb-0">
							<div class="container">
								<div class="row justify-content-center">
									<div class="col-sm-6">
										<input type="submit" value="등록하기" class="btn btn-primary btn-block btn-lg">
									</div>
									<div class="col-sm-6">
