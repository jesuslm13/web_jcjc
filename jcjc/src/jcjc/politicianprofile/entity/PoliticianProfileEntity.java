package jcjc.politicianprofile.entity;

public class PoliticianProfileEntity {
	...
	public PoliticianProfileEntity() {
		super();
	}

	public PoliticianProfileEntity(int politician_no, int politician_num, String politician_kor_name,
			String politician_hj_name, String politician_eng_name, String bth_date, String poly_name, String orig_name,
			String shrt_name, String reele_gbn_name, String election_name, String assem_tel, String assem_homep,
			String assem_email, String hbby_cd, String exam_cd, String politician_jpg_link) {
		super();
		this.politician_no = politician_no;
		this.politician_num = politician_num;
	...
	public int getPolitician_num() {
		return politician_num;
	}

	public void setPolitician_num(int politician_num) {
		this.politician_num = politician_num;
	}
	...
	public String toString() {
		return "PoliticianProfileEntity [politician_no=" + politician_no + ", politician_num=" + politician_num
				+ ", politician_kor_name=" + politician_kor_name + ", politician_hj_name=" + politician_hj_name
				+ ", politician_eng_name=" + politician_eng_name + ", bth_date=" + bth_date + ", poly_name=" + poly_name
				+ ", orig_name=" + orig_name + ", shrt_name=" + shrt_name + ", reele_gbn_name=" + reele_gbn_name
				+ ", election_name=" + election_name + ", assem_tel=" + assem_tel + ", assem_homep=" + assem_homep
				+ ", assem_email=" + assem_email + ", hbby_cd=" + hbby_cd + ", exam_cd=" + exam_cd
				+ ", politician_jpg_link=" + politician_jpg_link + "]";
	}
}
